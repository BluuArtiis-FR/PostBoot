      ...
      <div className="card mb-8 border-2 border-purple-200">
        ...
        {userConfig.modules.ui.enabled && (
          <div className="border-t pt-4">
            ...
            {/* Bandeau info fond d'écran Tenor - Obligatoire */}
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-300 rounded-lg p-4 mt-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-semibold text-gray-900">Fond d'écran Tenor Data Solutions</h4>
                    <span className="text-xs bg-blue-500 text-white px-2 py-1 rounded font-semibold">🏢 OBLIGATOIRE</span>
                  </div>
                  <p className="text-sm text-gray-700 mb-2">
                    Le fond d'écran et l'écran de verrouillage Tenor seront automatiquement appliqués lors de la personnalisation de l'interface.
                  </p>
                  <div className="bg-white rounded p-3 text-xs text-gray-600 space-y-1">
                    <p>• <strong>Fond d'écran bureau</strong> : Image Tenor Data Solutions personnalisée</p>
                    <p>• <strong>Écran de verrouillage</strong> : Branding Tenor avec désactivation Windows Spotlight</p>
                    <p>• <strong>Téléchargement automatique</strong> : Image récupérée depuis le serveur</p>
                  </div>
                </div>
              </div>
            </div>
